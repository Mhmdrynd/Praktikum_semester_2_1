...
<body>
    ...
    $nama_mahasiswa = $_GET['nama__lengkap']; 
    $mata_kuliah = $_GET['mata__kuliah'];
    $nilai_ulangan_tengah_semester = $_GET['nilai__uts'];
    $nilai_ujian_akhir_semester = $_GET['nilai__uas'];
    ...
    $ns5 = ['id'=>5,'nim'=>$nim,'uts'=>$nilai_ulangan_tengah_semester,'uas'=>$nilai_ujian_akhir_semester,'tugas'=>$nilai_tugas];
